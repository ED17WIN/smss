...
<head>
    ...
    <title>Clothes and Shoe Store</title>
...
<body>
    <div class="brand">CHEMAI STORE</div>
    <div class="address-bar"><strong>Cheap</strong> Shoes & Clothes for Everyone</div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">CHEMAI STORE</a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="index.php">Home</a></li>
					<li><a href="bestseller.php">Best Sales</a></li>
    ...
    <div class="container">
                ...
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <img class="img-responsive img-full" src="img/W8.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/heel2.jpg" alt="">
                            </div>
							<div class="item">
                                <img class="img-responsive img-full" src="img/k3.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/W3.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/k2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/W4.jpg" alt="">
                            </div>
                        </div>
		...
		<?php 
			...
			$sql = "SELECT * FROM `tbl_products` Limit 1000000000";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
					...
					Copyright &copy; CHEMAI STORE 2022
					</p>

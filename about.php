    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                    <img class="img-responsive img-border-left" src="img/homepage.jpg" alt="">
                </div>
                <div class="col-md-6">
                    <p>CHEMAI STORES is a web store that sells products such as clothes, shoes etc. in online shop. They deal with the local and international customers around the globe. We sell women,men and children clothes as well as men, women and children shoes.
                    </p> 
